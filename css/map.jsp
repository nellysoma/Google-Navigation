...
<html>
    <head>
        <title>UNIPORT Campus Navigation</title
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4" id="map1">
                    <h1>UNIPORT Campus Navigation</h1>
            ...
            <div class="containerf">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-4"></div>
                        <div class="col-md-4">
                            <p class="text-muted">&COPY; 2019 University of Port Harcourt.</p>
                        </div>
     ...
     <script type="text/javascript">
            ...
            function initMap() {
                ...
                // The marker, positioned at uniport
                 var marker = new google.maps.Marker({position: uniport, map: map})
